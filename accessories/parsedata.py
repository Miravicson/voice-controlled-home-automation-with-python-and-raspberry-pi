...
# curl -o weather_data.json somefile -k https://ef5128a4-86b4-47b8-b14f-a0cd74abf0ef:MwN42ReQZ9@twcservice.mybluemix.net:443/api/weather/v1/geocode/45.42/75.69/forecast/daily/3day.json
...
for key, value in data.items():
    ...
    if isinstance(value, list):
        ...
        for p in value:
            ...
            for k, v in p.items():
                if (
                                                k == "max_temp" or k == "min_temp" or k == "narrative" or k == "dow" or k == "lunar_phase" or k == "fcst_valid"):
                    map2 = str(v)
