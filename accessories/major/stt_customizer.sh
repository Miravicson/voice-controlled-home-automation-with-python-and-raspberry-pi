...
#USERNAME="f1394c7e-9664-413b-8ece-2426138c6bdb" older username
#PASSWORD="buMI6plnmhye"                          older password

#USERNAME="841498fa-7a18-4d49-9207-b75ac0a07357"  old username
#PASSWORD="PfFKHjaYAaib"                          old password

USERNAME="c13b3894-37b1-4a86-9225-a8636d9bc623"
PASSWORD="roLSkV3W1HYP"
#
...
curl -X POST $INSECURE -i -u "$USERNAME":"$PASSWORD" \
  ...
  --data "{\"name\": \"new_annah\", \
    ...
    \"description\": \"Annah instructions\"}" \
